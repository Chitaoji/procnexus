...
Create a process-backed runner or, with `threaded=True`, a thread-backed
runner from a callable.
...
current process; otherwise it starts the selected worker pool asynchronously.
